...
'window.FigEditor=window.FigEditor||{static:true,fitAll:fit,renderAll:noop,setEdit:noop,isEditing:function(){return false},'+
...
function exportStatic(){
  ...
  liveNodes.forEach(function(n,i){ var c=cloneNodes[i]; if(c&&!n.style.height) c.style.height=n.offsetHeight+'px'; });
  ...
  if(b){
    ...
    Array.prototype.slice.call(b.querySelectorAll('[contenteditable]')).forEach(function(el){ el.removeAttribute('contenteditable'); });
    b.classList.remove('fig-editing'); if(!b.className) b.removeAttribute('class');
